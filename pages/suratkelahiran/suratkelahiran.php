          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Buat Surat Kelahiran <?php echo $data_warga[0]['nama'] ?></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="form" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="prosessurat.php">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="ayah" name="ayah" value="<?php echo $data_warga[0]['ayah'] ?>" required="required" class="form-control col-md-7 col-xs-12"readonly >
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="ibu" name="ibu" value="<?php echo $data_warga[0]['ibu'] ?>" class="form-control col-md-7 col-xs-12" readonly >
                        </div>
                      </div>
