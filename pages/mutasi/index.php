          ...
          <div class="">
            <div class="page-title">
              ...
              <br>
               ...
               <a href="cari.php"><button type="button" class="btn btn-primary">Tambah Pindah</button></a>
              </div>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <?php foreach ($data_warga as $warga) : ?>
                        <tr>
                          ...
                          ?></td>
                          <td>
                            <a href="delete.php?id_mutasi=<?php echo $warga['id_mutasi'] ?>" onclick="return confirm('Yakin hapus data ini?')"class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
                      <?php endforeach ?>
