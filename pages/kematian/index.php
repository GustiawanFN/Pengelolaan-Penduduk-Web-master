          ...
          <div class="">
            <div class="page-title">
              ...
              <br>
               ...
               <a href="cari.php"><button type="button" class="btn btn-primary">Tambah Kematian</button></a>
              </div>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <?php foreach ($data_warga as $warga) : ?>
                        <tr>
                          ...
                          <td><?php echo $warga['waktu'] ?></td>
                          <td><?php echo $warga['hari'] ?></td>
                          <td><?php echo $warga['tempat_meninggal'] ?></td>
                          <td><?php echo $warga['penyebab'] ?></td>
                          <td>
                            <a href="../suratkematian/suratkematian.php?id_mati=<?php echo $warga['id_mati'] ?>" class="btn btn-default btn-xs"><i class="fa fa-trash-o"></i> Surat </a>
                            <a href="delete.php?id_mati=<?php echo $warga['id_mati'] ?>" onclick="return confirm('Yakin hapus data ini?')"class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
                      <?php endforeach ?>
