          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Form surat Mutasi Datang</h3>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Buat Surat Datang <?php echo $data_warga[0]['nik'] ?></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="form" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="prosessuratdatang.php">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="alamat" name="alamat" value="Dusun <?php echo $data_warga[0]['alamat_sebelum'] ?>" required="required" class="form-control col-md-7 col-xs-12" readonly >
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="addres" name="addres" value="Dusun <?php echo $data_warga[0]['dusun'] ?>, Rt / Rw <?php echo $data_warga[0]['rw'] ?>/<?php echo $data_warga[0]['rw'] ?>, <?php echo $data_warga[0]['alamat'] ?> Kecamatan Ciawigebang Kabupaten Kuningan " required="required" class="form-control col-md-7 col-xs-12"readonly >
                        </div>
                      </div>
                        <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tanggal">Tanggal Datang<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
