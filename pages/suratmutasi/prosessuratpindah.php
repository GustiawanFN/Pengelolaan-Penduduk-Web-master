...
$document = file_get_contents('../../surat/pindah.rtf');
...
// document dokumen dinyatakan dalam bentuk string
	...
	$document = str_replace('DATA_ADDRES', $data_addres, $document);
...
header("Content-disposition: inline; filename=Surat_Pindah.doc");
