...
header("content-disposition: attachment;filename=report_Data_penduduk_desa_cipetir.doc");
?>

<center><h2>Laporan Kematian Penduduk Desa Cipetir</h2></center>
<table border='1'>
<h3>
<thead><tr>
...
<tbody>
    ...
    <?php 
        ...
        $query = "SELECT * FROM penduduk WHERE status='4'";
